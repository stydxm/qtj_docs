...
- 从2023赛季开始，哨兵可以在整个场地内自由活动，因此视觉组增加了导航和自主决策的任务；随后删除了“巡逻区”的概念、去掉了双头和特殊的尺寸重量限制，使得哨兵完全成为了第三台步兵

- [南科大（哈工程）](https://www.bilibili.com/video/BV1QA4m1w7KN)[^1]、[南昌航空](https://www.bilibili.com/video/BV14eKKeiEJB)、[复旦](https://www.bilibili.com/video/BV1wp63BBEyA)等学校的队伍开始了强化学习控制算法的研究，以期替代传统控制方法

[^1]: 该项目作者王洪玺，本科在哈工程打比赛，后去南科读研

- [广工的无下位机方案](https://github.com/rm-controls)用上位机直连电机控制机器人，把算法组与电控组这两个工种合二为一；[南京理工上位机控制、下位机连接硬件的方案](https://github.com/Alliance-Algorithm/RMCS)在保留纯上位机高复用性、高工程化程度、快速开发迭代的同时，提高了硬件连接的可靠性，综合了二者优点
...
[DX-ROS教程（西安交通大学笃行机器人队）](https://docs.qq.com/markdown/DR0dTc2NmUEZSTERF)  
[上海科技大学2026视觉技术方案开源](https://fcn47qghdcqf.feishu.cn/wiki/Hcw1wxTMZicx0xkinuQcKHetn5d)  
